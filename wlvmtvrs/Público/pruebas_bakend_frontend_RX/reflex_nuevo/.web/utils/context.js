...
export const StateContexts = {
  ...
  reflex___state____state__reflex_nuevo___reflex_nuevo____state: createContext(null),
...
export const lastCompiledTimeStamp = "2025-06-13 14:44:14.387726"
...
export function StateProvider({ children }) {
  ...
  const [reflex___state____state__reflex_nuevo___reflex_nuevo____state, dispatch_reflex___state____state__reflex_nuevo___reflex_nuevo____state] = useReducer(applyDelta, initialState["reflex___state____state.reflex_nuevo___reflex_nuevo____state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "reflex___state____state.reflex_nuevo___reflex_nuevo____state": dispatch_reflex___state____state__reflex_nuevo___reflex_nuevo____state,
  ...
  return (
    ...
    createElement(StateContexts.reflex___state____state__reflex_nuevo___reflex_nuevo____state,{value: reflex___state____state__reflex_nuevo___reflex_nuevo____state},
